...
public class MainActivity extends Activity {
    ...
    private static final String TAG = "PartySafe";
    ...
    public void linkUserToParse(final ParseUser user)
    {
    ...
    private void showHomeActivity() {
        ...
        // Get user id
        Log.i("MainActivity", "Attempt to get user id");
        user_ID = ParseUser.getCurrentUser().getUsername();
        Log.i("MainActivity", "user_ID: " + user_ID);
